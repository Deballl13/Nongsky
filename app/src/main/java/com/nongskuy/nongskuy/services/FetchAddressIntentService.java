package com.nongskuy.nongskuy.services;
...
import com.nongskuy.nongskuy.Config;
...
public class FetchAddressIntentService extends IntentService {
    ...
    public void deliverResultToReceiver(Integer resultCode, String addressMessage) {
        Bundle bundle = new Bundle();
        bundle.putString(Config.RESULT_DATA_KEY, addressMessage);
